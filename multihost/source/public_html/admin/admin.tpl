...
<script type="text/javascript">
	function begin_upgrade()
	{
		...
		$("input[id=upgrade_button]").attr("disabled", "disabled");
		
		/*var download_data = get_ajax_content("admin.php?act=upgrade-df");
		...
		switch (download_data) {
			...
			case "003":
				...
				break;
			case "004":
				location.href = "admin.php?act=upgrade-d";
				break;
		}
        	...
        	<td class="tdrow1"><br />
                ...
                <ol>
                    <while id="changed_file_list">
                        <li><a href="admin.php?act=filediff&amp;file=<# FILENAME #>" target="_blank"><# FILENAME #></a></li>
                    </endwhile>
                </ol><br />
			</td>
		</tr>
...
<div class="align_left_mfix">
    <ul class="jd_menu">
     	<li><span class="button1">More Settings</span>
         	<ul class="menu_border">
            	<li class="header">Settings</li>
            	<li class="item"><a href="admin.php?act=language_settings">Language Settings</a></li>
                <li class="item"><a href="javascript:void(0);" onclick="$('tr[class=misc_settings]').toggle(); if($('tr[class=misc_settings]:visible').length > 1){scroll($(document).width(), $(document).height());}">Miscellaneous Settings</a></li>
            </ul>
		</li>
        
   		<li><a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&amp;hosted_button_id=7572182" class="button1" title="Help keep Mihalism Multi Host alive."><strong>Donate</strong></a></li> 
   		<li><a href="http://www.mihalism.net/multihost/support.php" class="button1" title="Community Support">Report Bug</a></li> 
	</ul>
</div>
...
<form action="admin.php?act=site_settings-s" method="post">
	<div class="table_border">
		<table cellpadding="4" cellspacing="1" border="0" style="width: 100%;">
			...
			<tr>
				<td style="width: 38%;" class="tdrow1"><span>Max Bandwidth:</span> <br /> <div class="explain">The maximum allowed <a href="http://en.wikipedia.org/wiki/Bandwidth_(computing)">bandwidth use</a> per file for Guests. Bandwidth tracking requires that the setting "<a href="#proxyimages">Proxy Images</a>" be enabled.</div></td> 
			...
			<tr>
				<td style="width: 38%;" class="tdrow1"><span>Max Bandwidth (Users):</span> <br /> <div class="explain">The maximum allowed <a href="http://en.wikipedia.org/wiki/Bandwidth_(computing)">bandwidth use</a> per file for registered users. Bandwidth tracking requires that the setting "<a href="#proxyimages">Proxy Images</a>" be enabled.</div></td> 
			...
			<tr>
				<td style="width: 38%;" class="tdrow1"><span>Thumbnail Format:</span> <br /> <div class="explain">This setting can have a large effect on bandwidth usage. For a side-by-side size comparison click <a href="css/images/thumbnail_compare.png">here</a>. Only thumbnails created after a change to this setting will be affected by the change.</div></td> 
				<td class="tdrow2" valign="top">
			...
			<tr>
				<td style="width: 38%;" class="tdrow1"><span>Advanced Thumbnails:</span> <br /> <div class="explain">For an example of an advanced thumbnail click <a href="css/images/adv_thumb_ex.png">here</a>. Only thumbnails created after a change to this setting will be affected by the change.<br /><br />Advanced Thumbnails have been redesigned for websites that are running <a href="http://pecl.php.net/package/imagick">Imagick Image Library</a> 2.3.0 or later. <a href="css/images/adv_thumb_ex_2.png">View new design</a>.</div></td> 
				<td class="tdrow2" valign="top">
